                        ...
                        <div class="col-md-8  col-md-offset-2 profile1">
                            ...
                            <form class="form-horizontal" wire:submit.prevent='updateServiceCategory'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name" wire:model='name' wire:keyup='generatslug'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control-file" name="image" wire:model.debounce.1000ms='newimage' >
